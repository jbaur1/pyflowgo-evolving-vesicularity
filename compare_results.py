...
if __name__ == "__main__":
    ...
    for filename in filename_array:
        ...
        if '1' in figs:
            ...
            #plot1_fig1.set_xlim(xmax=13500)
            ...
            #plot2_fig1.set_xlim(xmax=13500)
            # plot2_fig1.set_ylim(bottom=0, top=100)
            ...
            #plot3_fig1.set_ylim(bottom=10, top=10000000)
            #plot3_fig1.set_xlim(xmax=13500)
            ...
            #plot4_fig1.set_xlim(xmax=13500)
            ...
            plot5_fig1.set_ylim(bottom=0, top=600)
            plot5_fig1.set_xlim(xmax=13500)
            ...
            plot6_fig1.set_xlim(xmax=13500)
        ...
        if '5' in figs:
            plot1_fig5.plot(distance_array, depth_array, '-',  label = label)
            plot1_fig5.set_xlabel('Distance (m)')
            plot1_fig5.set_ylabel('Depth (m)')
            plot1_fig5.grid(True)
            plot1_fig5.set_title("Depth for " + str(title))
...
print('Max distance is ' + str(max(distance_array)))