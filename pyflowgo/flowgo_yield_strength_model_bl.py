...
class FlowGoYieldStrengthModelBirnbaumLev(pyflowgo.base.flowgo_base_yield_strength_model.FlowGoBaseYieldStrengthModel):
    ...
    def compute_yield_strength(self, state, eruption_temperature):
        ...
        phi_crit = 0.34
        tho_0 = math.pow(10,61*(crystal_fraction/(1-vesicle_fraction) - phi_crit)) + math.exp(1.98*(crystal_fraction/(1-vesicle_fraction) + vesicle_fraction - phi_crit))
        return tho_0
