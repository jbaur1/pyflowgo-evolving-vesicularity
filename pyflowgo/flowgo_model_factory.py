...
class FlowgoModelFactory:
    def __init__(self, configuration_file, terrain_condition):
        ...
        if self._vesicle_fraction_model == "constant":
            ...
            raise NameError('vesicle fraction model must be "constant" or "bimodal" or "poly" or ... ')
        ...
        if self._relative_viscosity_model == "er":
            ...
            self._relative_viscosity_model_object = pyflowgo.flowgo_relative_viscosity_model_bl.\
                FlowGoRelativeViscosityModelBirnbaumLev(vesicle_fraction_model=self._vesicle_fraction_model_object, melt_viscosity_model=self._melt_viscosity_model_object)
        else:
