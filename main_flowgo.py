...
# --------------------------------- READ INITIAL CONFIGURATION FILE AND MODEL FACTORY ----------------------------------
    ...
    integrator = pyflowgo.flowgo_integrator.FlowGoIntegrator(step_size,
                                                             material_lava=material_lava,
    ...
    logger.write_values_to_file("/Users/Jasper/Volc_Research/Pyflowgo/pyflowgo-master-2/results2/results_"+str(lava_name).replace(" ", "_").lower() + "_"+ str(step_size) + "m.csv")
