...
if __name__ == "__main__":
    ...
    figs = sys.argv[3] # which figures to plot, if none given plots all
    if '0' in figs:
        figs = '1, 2, 3, 4'
    ...
    for filename in filename_array:
        ...
        if '1' in figs:
            ...
            plot3_fig1.set_ylim(bottom=1, top=1000000)
            ...
            plot5_fig1.set_ylim(bottom=0, top=200)
